...
def GetRdf3D(lcoordinates):

    dout = {}
    dout.update(CalculateUnweightRDF(lcoordinates))
    dout.update(CalculateChargeRDF(lcoordinates))
    dout.update(CalculateMassRDF(lcoordinates))
    dout.update(CalculatePolarizabilityRDF(lcoordinates))
    dout.update(CalculateSandersonElectronegativityRDF(lcoordinates))
    dout.update(CalculateVDWVolumeRDF(lcoordinates))
